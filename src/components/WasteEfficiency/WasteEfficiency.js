...
const WasteEfficiency = () => {
  return (
    <div className="bg-gray-100 p-2 flex items-center justify-between my-12 cursor-pointer rounded-md md:w-fit md:transition-all md:hover:scale-[1.01] md:hover:shadow-xl">
